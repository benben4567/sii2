        ...
        <div class="col-md-12">
          <div class="table-rep-plugin">
            <div class="table-responsive b-0" data-pattern="priority-columns">
              <table class="table table-bordered  nowrap table-detail-penyusun" style="border-collapse: collapse; border-spacing: 0; width: 100%;" >
                <thead>
                  <tr>
                    <th>File Materi Pembelajaran</th>
