    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="page-title-box page-title-box-dark">
          <h4 class="page-title">Data Penyusun</h4>
          <ol class="breadcrumb">
          ...
          <div class="card m-b-20">
            <div class="card-body">
              <div class="form-group">
                <label>Cari judul pembelajaran</label>
...
@include('page.pengalaman.penyusun.modal-admin')
@section('js')
<script type="text/javascript">
  ...
  $(function(){
    ...
    table1 = $('.table-detail-penyusun').DataTable({
      "processing" :true,
      "serverside" : true,
      'destroy': true,
      'paging': false,
    ...
    $('select#pilihjudul').select2({
      ...
      ajax: {
        url: '{{route('masterPenyusun.select2judul')}}',
        dataType: 'json',
  ...
  function viewForm(id){
    $.ajax({
      ...
      success : function(data){
        ...
        table1.ajax.url("masterPenyusun/"+id+"/dataDetail");
        table1.ajax.reload();
      },
      error : function(){
  ...
  function cariForm(id){
    ...
    $.ajax({
      url: "masterPenyusun/"+id+"/getDataAdmin",
      type: "GET",
      dataType: "JSON",
      success : function(data){
        $('#muncul-table').show();
        toastr.success('Berhasil menampilkan data!', 'Success Alert', {timeOut: 3000});
        table.ajax.url("masterPenyusun/"+id+"/data");
        table.ajax.reload();
      },
      error : function(){
        toastr.warning('Tidak dapat menampilkan data!', 'Error Alert', {timeOut: 3000});
