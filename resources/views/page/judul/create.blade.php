@extends('layouts.app')
@section('title', 'Judul Pembelajaran')
@section('content')
<!-- Start content -->
<div class="content">
        ...
        <div class="row">
          <div class="col-6">
            <div class="card m-b-20">
              ...
              <div class="card-body">
                <form method="post" action="/judul" id="form-instruktur" target="votar">
                  {{ csrf_field() }}
                  <div class="form-group row">
                    <label for="kode_judul" class="col-sm-4 col-form-label">Kode Judul</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control @error('kode_judul') is-invalid @enderror" id="kode_judul" name="kode_judul" value="{{old('kode_judul')}}">
                      @error('kode_judul')
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control @error('kode_judul_lama') is-invalid @enderror" id="kode_judul_lama" name="kode_judul_lama" value="{{old('kode_judul_lama')}}">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control @error('nama_judul') is-invalid @enderror" id="nama_judul" name="nama_judul"  value="{{old('nama_judul')}}">
                      @error('nama_judul')
                      <div class="invalid-feedback">{{$message}}</div>
                      @enderror
                    </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control @error('jenis_diklat') is-invalid @enderror" id="jenis_diklat" name="jenis_diklat"  value="{{old('jenis_diklat')}}">
                      @error('jenis_diklat')
                      <div class="invalid-feedback">{{$message}}</div>
                      @enderror
                    </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control @error('sifat_diklat') is-invalid @enderror" id="sifat_diklat" name="sifat_diklat"  value="{{old('sifat_diklat')}}">
                      @error('sifat_diklat')
                      <div class="invalid-feedback">{{$message}}</div>
                      @enderror
                    </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control @error('dahan_profesi') is-invalid @enderror" id="dahan_profesi" name="dahan_profesi"  value="{{old('dahan_profesi')}}">
                      @error('dahan_profesi')
                      <div class="invalid-feedback">{{$message}}</div>
                      @enderror
                    </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control @error('level_profisiensi') is-invalid @enderror" id="level_profisiensi" name="level_profisiensi"  value="{{old('level_profisiensi')}}">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control @error('penyelenggaraan') is-invalid @enderror" id="penyelenggaraan" name="penyelenggaraan"  value="{{old('penyelenggaraan')}}">
              ...
              <div class="card m-b-20">
                <div class="card-body">
                 <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                      <select class="form-control" id="jenis_sertifikat" name="jenis_sertifikat" value="{{old('jenis_sertifikat')}}">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <input type="number" min="0" class="form-control @error('durasi_hari_efektif') is-invalid @enderror" id="durasi_hari_efektif" name="durasi_hari_efektif"  value="{{old('durasi_hari_efektif')}}">
                      @error('durasi_hari_efektif')
                      <div class="invalid-feedback">{{$message}}</div>
                      @enderror
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <input type="number" min="0" class="form-control @error('total_jp_materi') is-invalid @enderror" id="total_jp_materi" name="total_jp_materi"  value="{{old('total_jp_materi')}}">
                      @error('total_jp_materi')
                      <div class="invalid-feedback">{{$message}}</div>
                      @enderror
                    </div>
                  </div>
                    ...
                    <div class="col-sm-4">
                      <input type="number" min="0" class="form-control @error('jml_pagu_anggaran') is-invalid @enderror" id="jml_pagu_anggaran" name="jml_pagu_anggaran"  value="{{old('jml_pagu_anggaran')}}">
                      @error('jml_pagu_anggaran')
                      <div class="invalid-feedback">{{$message}}</div>
                      @enderror
                    </div>
                  </div>
                    ...
                    <div class="col-sm-6">
                      <input  type="date" class="form-control @error('tanggal_input_judul') is-invalid @enderror" id="tanggal_input_judul" name="tanggal_input_judul"  value="{{old('tanggal_input_judul')}}">
