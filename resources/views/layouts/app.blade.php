...
<head>
  ...
  <!-- DataTables -->
  <link href="{{asset('assets/plugins/DataTables-1.10.20//css/dataTables.bootstrap4.min.css')}}" rel="stylesheet" type="text/css" />
...
<body>
  ...
  <script src="{{asset('assets/plugins/DataTables-1.10.20/js/jquery.dataTables.min.js')}}"></script>
  <script src="{{asset('assets/plugins/DataTables-1.10.20/js/dataTables.bootstrap4.min.js')}}"></script>
  <!-- Buttons examples -->
